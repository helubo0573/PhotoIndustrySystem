package com.stone.phtotindustry.manage.interceptor;
...
import com.stone.photoindustry.core.common.util.DateUtils;
...
public class ConLogInterceptor implements HandlerInterceptor {
	...
	public void afterCompletion(HttpServletRequest request, HttpServletResponse response, Object handler, Exception ex)
		...
		if (logger.isDebugEnabled()) {
			...
			String ip = getRemoteHost(request);
			logger.debug("{}响应结束：  耗时：{}  URI: {}  最大内存: {}m  已分配内存: {}m  剩余内存: {}m  最大可用内存: {}m", ip,
